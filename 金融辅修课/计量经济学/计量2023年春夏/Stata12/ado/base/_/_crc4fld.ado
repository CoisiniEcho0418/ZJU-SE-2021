...
program define _crc4fld
	...
	local row1=substr(`"`row1'"',1,16)
	local s1 = 16-length(`"`row1'"')
	...
	local row2=substr(`"`row2'"',1,16)
	local s1 = 16-length(`"`row2'"')

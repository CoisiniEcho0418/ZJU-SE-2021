...
{viewerjumpto "Saved results" "_datasignature##saved_results"}{...}
{title:Title}

{p2colset 5 27 29 2}{...}
{p2col:{manlink P _datasignature} {hline 2}}Determine whether data have changed
{p_end}
{p2colreset}{...}
...
{pstd}
{cmd:_datasignature} calculates, displays, and saves in {cmd:r(_datasignature)}
checksums of the data, forming a signature.  A signature might be

	162:11(12321):2725060400:4007406597

{pstd}
The signature can be saved and later used to determine whether the data have
changed.
...
{pstd}
{cmd:_datasignature} saves the following in {cmd:r()}:

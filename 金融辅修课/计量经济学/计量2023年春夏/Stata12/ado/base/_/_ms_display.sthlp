...
{viewerjumpto "Saved results" "_ms_display##saved_results"}{...}
{title:Title}
...
{phang}
{opt matrix(name)} specifies that {cmd:_ms_display} report information from the
...
{pstd}
{cmd:_ms_display} saves the following in {cmd:r()}:

...
{p2colset 5 33 35 2}{...}
{p2col :{manlinki G-3 added_text_options} {hline 2}}Options for adding text to twoway graphs{p_end}
{p2colreset}{...}
...
{manhelpi textbox_options G-3} and {manhelpi relativesize G-4}.

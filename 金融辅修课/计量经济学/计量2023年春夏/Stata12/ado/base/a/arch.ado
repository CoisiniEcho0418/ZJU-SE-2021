...
program define DisplayHdr
	...
	di `osmpl'							/*
		*/ _col(52) in gr "Number of obs" in gr _col(68) "="	/*
		*/ in ye _col(70) %9.0g e(N)

	if !missing(e(df_r)) {
		local model _col(52) as txt "F(" ///
			as res %3.0f e(df_m) as txt "," ///
			as res %6.0f e(df_r) as txt ")" _col(68) ///
			"=" _col(70) as res %9.2f e(F)
		local pvalue _col(52) as txt "Prob > F" _col(68) ///
		...
		local model _col(52) as txt `"`chitype' chi2("' ///
			as res e(df_m) as txt ")" _col(68) ///
			"=" _col(70) as res %9.2f e(chi2)
		local pvalue _col(52) as txt "Prob > chi2" _col(68) ///

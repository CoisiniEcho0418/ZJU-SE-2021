{smcl}
{* *! version 1.3.23  16may2011}{...}
{viewerdialog asroprobit "dialog asroprobit"}{...}
{vieweralsosee "[R] asroprobit" "mansection R asroprobit"}{...}
{vieweralsosee "" "--"}{...}
...
{viewerjumpto "Saved results" "asroprobit##saved_results"}{...}
{title:Title}

{p2colset 5 23 25 2}{...}
{synopt :{manlink R asroprobit} {hline 2}}Alternative-specific rank-ordered
...
{synopt :{it:{help asroprobit##display_options:display_options}}}control column
...
{pstd}
{cmd:asroprobit} saves the following in {cmd:e()}:

...
{p2colset 5 30 32 2}{...}
{p2col :{manlinki G-3 barlook_options} {hline 2}}Options for setting the look of bars{p_end}
{p2colreset}{...}
...
{p2line}
{p2col:{cmdab:col:or:(}{it:{help colorstyle}}{cmd:)}}outline and fill color{p_end}
...
{p2col:{cmdab:lc:olor:(}{it:{help colorstyle}}{cmd:)}}outline color{p_end}

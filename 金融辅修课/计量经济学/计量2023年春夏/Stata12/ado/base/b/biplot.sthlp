...
{viewerjumpto "Saved results" "biplot##saved_results"}{...}
{title:Title}

{p2colset 5 20 22 2}{...}
{p2col :{manlink MV biplot} {hline 2}}Biplots{p_end}
{p2colreset}{...}
...
{pstd}
{cmd:biplot} saves the following in {cmd:r()}:

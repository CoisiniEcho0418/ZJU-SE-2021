...
{viewerjumpto "Saved results" "bitest##saved_results"}{...}
{title:Title}

{p2colset 5 19 21 2}{...}
{p2col :{manlink R bitest} {hline 2}}Binomial probability test{p_end}
{p2colreset}{...}
...
ignored.  See the 
{mansection R bitestRemarkstechnote:technical note} in {bf:[R] bitest} for
details.
...
{pstd}
{cmd:bitest} and {cmd:bitesti} save the following in {cmd:r()}:

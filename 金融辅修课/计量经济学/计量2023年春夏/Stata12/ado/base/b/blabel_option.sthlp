...
{viewerjumpto "Options" "blabel_option##options"}{...}
{viewerjumpto "Suboptions for use with blabel()" "blabel_option##suboptions"}{...}
{viewerjumpto "Remarks" "blabel_option##remarks"}{...}
{title:Title}

{p2colset 5 28 30 2}{...}
{p2col :{manlinki G-3 blabel_option} {hline 2}}Option for labeling bars{p_end}
{p2colreset}{...}
...
{synopt:{cmd:gap(}{it:{help relativesize}}{cmd:)}}distance from
        position{p_end}
...
{cmd:blabel(}{it:what}{cmd:,} {it:where_and_how}{cmd:)}
    ...
    {it:{help blabel_option##suboptions:Suboptions for use with blabel()}}
...
{cmd:gap(}{it:relativesize}{cmd:)}
    ...
    20%; see {manhelpi relativesize G-4}.
...
{it:textbox_options}
    ...
    of the text.  See {manhelpi textbox_options G-3}.

...
program ClustSubWgt
	...
	by `strata' `w' `r': gen `newclid' = (_n == 1) if `clid'
	`by' replace `newclid' = sum(`newclid') if `clid'
	by `strata' `w' `r': gen `kept' = _n==1 if `newclid' <= `nsamp'
	sort `strata' `clid'

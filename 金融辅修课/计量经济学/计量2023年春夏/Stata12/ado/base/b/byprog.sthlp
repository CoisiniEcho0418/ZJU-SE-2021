...
{p2colset 5 19 21 2}{...}
{p2col :{manlink P byable} {hline 2}}Make programs byable{p_end}
{p2colreset}{...}
...
wish that.  See {mansection P byableRemarks:{it:Remarks}} in 
...
{pstd}
See {mansection P byableRemarks:{it:Remarks}} in {bf:[P] byable}

...
{p2colset 5 37 39 2}{...}
{p2col :{manlinki G-3 cat_axis_label_options} {hline 2}}Options for specifying look of categorical axis labels{p_end}
{p2colreset}{...}
...
{p2col:{cmd:labgap(}{it:{help relativesize}}{cmd:)}}labels: margin between
...
{p2col:{cmdab:labs:ize:(}{it:{help textsizestyle}}{cmd:)}}labels: size of
        text{p_end}
{p2col:{cmdab:labc:olor:(}{it:{help colorstyle}}{cmd:)}}labels: color of
        text{p_end}
...
{cmd:tstyle(}{it:tickstyle}{cmd:)}
    ...
    {manhelpi tickstyle G-3}.  Here the
...
{opt labcolor(colorstyle)}
    ...
    Also see {manhelpi relativesize G-4} and {manhelpi textstyle G-4}.

...
{p2colset 5 36 38 2}{...}
{p2col :{manlinki G-3 cat_axis_line_options} {hline 2}}Options for specifying look of categorical axis line{p_end}
{p2colreset}{...}
...
{p2col:{cmdab:outerg:ap:(}{it:{help relativesize}}{cmd:)}}margin outside of
      axis title{p_end}
...
{cmd:titlegap(}{it:relativesize}{cmd:)} specifies the margin to be inserted
     ...
     {manhelpi relativesize G-3}.

{phang}
{cmd:outergap(}{it:relativesize}{cmd:)} specifies the margin to be inserted
     outside the axis title; see {manhelpi relativesize G-3}.

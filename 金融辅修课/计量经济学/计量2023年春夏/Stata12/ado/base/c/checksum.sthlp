...
{viewerjumpto "Saved results" "checksum##saved_results"}{...}
{title:Title}

{p2colset 5 21 23 2}{...}
{p2col:  {manlink D checksum} {hline 2}}Calculate checksum of file{p_end}
{p2colreset}{...}
...
{phang2}Checksum for auto.dta = 960409748, size = 5949
...
{pstd}
{cmd:checksum} saves the following in {cmd:r()}:

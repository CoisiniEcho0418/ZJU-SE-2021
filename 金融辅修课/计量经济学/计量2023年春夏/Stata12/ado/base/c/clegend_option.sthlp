...
{p2colset 5 29 31 2}{...}
{p2col :{manlinki G-3 clegend_option} {hline 2}}Option for controlling the
...
{synopt:{opth width(relativesize)}}width of contour key{p_end}
{synopt:{opth height(relativesize)}}height of contour key{p_end}
...
{phang}
    {opt width(relativesize)} specifies the width of the contour key.
    See {manhelpi relativesize G-4}.

{phang}
    {opt height(relativesize)} specifies the height of the contour key.
    See {manhelpi relativesize G-4}.

...
{p2colset 5 21 23 2}{...}
{p2col :{manlink MV cluster} {hline 2}}Introduction to cluster-analysis commands{p_end}
{p2colreset}{...}
...
are detailed in their respective manual entries.
	...
	Postclustering commands
	    ...
	    Generate summary variables{col 44}{helpb cluster generate}
	...
	in the {help cluster linkage} help file.  Also see

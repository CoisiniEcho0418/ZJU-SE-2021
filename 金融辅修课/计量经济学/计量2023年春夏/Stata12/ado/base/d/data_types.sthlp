...
{p2colset 5 23 25 2}{...}
{p2col :{manlink D data types} {hline 2}}Quick reference for data types{p_end}
{p2colreset}{...}
...
{pstd}
Each element of data is said to be either type string or numeric.  The word
...
{opt str3}, ..., {cmd:str244}.  The number after the
{opt str} indicates the maximum length of the string.  An {opt str5} could hold
...
{pstd}
One solution is to type "{cmd:list if x==float(.1)}".  The {opt float()}
function rounds its argument to float accuracy; see {manhelp functions D}.
...
financial data, store your dollar amounts as {opt double}s.  See
{helpb float()}.
{p_end}

...
{p2colset 5 21 30 2}{...}
{p2col :{manlink D datetime} {hline 2}}Date and time values and
variables{p_end}
{p2colreset}{...}
...
{help datetime##s1:previous section}.
	 ...
	 {hline 65}
         datetime/c      1,479,597,200,000     milliseconds since 
                                               01jan1960 00:00:00.000, 
					       assuming 86,400 s/day

	 datetime/C      1,479,596,223,000     milliseconds since 
                                               01jan1960 00:00:00.000, 
         ...
         quarterly date                 58     quarters since 1960q1
...
{marker s8}{...}
    {title:Extracting date components from SIFs}
       ...
       Desired component      Function                Example*
       {hline 54}
       calendar year          {cmd:year(}{it:td}{cmd:)}                   2011
       ...
       {hline 54}
{p 7 7 2}
* All examples are with {cmd:td=mdy(7,5,2011)}.{p_end}
{p 7 7 2}
...
The SIF pseudofunctions and their expected component order are 
	    ...
	    yearly date       {c |}  none necessary; just type year
...
{p_end}
{p 8 8 2}
    You are unlikely to encounter Excel numerically encoded dates.
    If you copy and paste a spreadsheet into Stata's editor, dates and 
    datetimes are pasted as strings in HRF.  If you use 
    a conversion package, most know how to convert the date for you.
...
{p 8 8 2}
    ...
    See {browse "http://support.microsoft.com/kb/214330"}

...
{viewerjumpto "Description" "dfactor postestimation##description"}{...}
{viewerjumpto "Syntax for predict" "dfactor postestimation##syntax_predict"}{...}
{viewerjumpto "Options for predict" "dfactor postestimation##options_predict"}{...}
{viewerjumpto "Examples" "dfactor postestimation##examples"}{...}
{title:Title}

{p2colset 5 36 40 2}{...}
{p2col :{manlink TS dfactor postestimation} {hline 2}}Postestimation tools for dfactor{p_end}
{p2colreset}{...}
...
{synopt :{cmd:rmse(}{it:stub}{cmd:*}{c |}{it:{help newvarlist}}{cmd:)}}put estimated
...
{phang} 
{cmd:rmse(}{it:stub}{cmd:*}{c |}{it:{help newvarlist}}{cmd:)} puts the root mean
...
{opt innovations}, {cmd:method(filter)}, or {cmd:smethod(smooth)}.

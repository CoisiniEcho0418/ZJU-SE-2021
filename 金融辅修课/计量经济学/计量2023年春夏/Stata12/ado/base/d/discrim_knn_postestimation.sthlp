...
{viewerjumpto "Description" "discrim knn postestimation##description"}{...}
{viewerjumpto "Syntax for predict" "discrim knn postestimation##syntax_predict"}{...}
{viewerjumpto "Options for predict" "discrim knn postestimation##options_predict"}{...}
{viewerjumpto "Examples" "discrim knn postestimation##examples"}{...}
{title:Title}

{p2colset 5 40 42 2}{...}
{p2col:{manlink MV discrim knn postestimation} {hline 2}}Postestimation tools 
        for discrim knn
{p_end}
{p2colreset}{...}

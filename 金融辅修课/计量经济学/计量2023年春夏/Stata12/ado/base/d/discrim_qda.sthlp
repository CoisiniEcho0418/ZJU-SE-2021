...
{viewerjumpto "Saved results" "discrim qda##saved_results"}{...}
{title:Title}

{p2colset 5 25 27 2}{...}
{p2col:{manlink MV discrim qda} {hline 2}}Quadratic discriminant analysis{p_end}
{p2colreset}{...}
...
{p 8 20 2}
{cmd:discrim} {cmd:qda} {varlist} {ifin} {weight}{cmd:,}
...
{pstd}
{cmd:discrim qda} saves the following in {cmd:e()}:

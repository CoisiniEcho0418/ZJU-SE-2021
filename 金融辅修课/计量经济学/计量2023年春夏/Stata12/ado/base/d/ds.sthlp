...
{viewerjumpto "Saved results" "ds##saved_results"}{...}
{title:Title}

{p2colset 5 15 17 2}{...}
{p2col :{manlink D ds} {hline 2}}List variables matching name
...
types, each of which may be {cmd:numeric}, {cmd:string},
...
{opt fc}.  {bind:{cmd:not(format %t* %-t*)}} would select all
...
{pstd}
{cmd:ds} saves the following in {cmd:r()}:

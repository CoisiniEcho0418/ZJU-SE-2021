...
{viewerjumpto "Syntax" "dta##syntax"}{...}
{viewerjumpto "Remarks" "dta##remarks"}{...}
{title:Title}

{p2colset 5 30 32 2}{...}
{p2col :{manlink P file formats .dta} {hline 2}}Description of .dta file format{p_end}
{p2colreset}{...}
...
what are known as {hi:format-115} datasets, the most modern format.  Stata
...
{help statamp:Stata/MP}.  The same {hi:115} format is used by all flavors.
...
The Header is defined as
	...
	{hline}
	{cmd:ds_format}                1    byte      contains 115 = 0x73
...
{pstd}
For earlier documentation, see {help dta_114}.
{p_end}

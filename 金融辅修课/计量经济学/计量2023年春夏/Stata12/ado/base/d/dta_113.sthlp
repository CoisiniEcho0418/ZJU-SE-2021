...
{viewerjumpto "Syntax" "dta_113##syntax"}{...}
{viewerjumpto "Remarks" "dta_113##remarks"}{...}
{title:Title}

{p2colset 5 44 46 2}{...}
{p2col :{hi:[P] file formats .dta} (113 version) {hline 2}}Description of .dta file format{p_end}
{p2colreset}{...}
...
{help statamp:Stata/MP}.  The same {hi:113} format is used by all flavors.
...
{pstd}
See {help dta} for the current version formats. 
{p_end}

...
{bf:Example datasets installed with Stata}
{hline}
{pstd}The datasets listed here are installed with Stata.  You can also
see a complete list of the
{help dta_manuals:datasets used in the Stata documentation} that
are available via the Internet.  Each manual title is listed as a link that
...
{hline}
{pstd}StataCorp gratefully acknowledges that some
datasets are proprietary and have been used
in our printed documentation with the express permission of the
copyright holders. If any copyright holder believes that by making
these datasets available to the public, StataCorp is in violation of
the letter or spirit of any such agreement, please contact

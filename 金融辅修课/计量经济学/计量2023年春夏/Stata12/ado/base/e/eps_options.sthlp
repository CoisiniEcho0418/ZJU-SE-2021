...
{p2colset 5 26 28 2}{...}
{p2col :{manlinki G-3 eps_options} {hline 2}}Options for exporting to Encapsulated PostScript{p_end}
{p2colreset}{...}
...
{browse "http://en.wikipedia.org/wiki/Type_1_and_Type_3_fonts#Core_Font_Set"}).

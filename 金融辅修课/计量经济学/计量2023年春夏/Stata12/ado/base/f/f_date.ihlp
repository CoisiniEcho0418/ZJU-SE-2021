...
{p2col 8 22 22 2:}{it:s1} contains the date, recorded as a string, in virtually
...
{p2col 8 22 22 2:}{it:s2} is any permutation of {cmd:M}, {cmd:D}, and
...
{p2col 8 22 22 2:}If neither {it:##} nor {it:Y} is specified, {cmd:date()}

{* *! version 1.0.1  15mar2007}{...}
    {cmd:Fden(}{it:n1}{cmd:,}{it:n2}{cmd:,}{it:f}{cmd:)}
{p2colset 8 22 26 2}{...}
...
{p2col: Description:}returns the
	probability density function for the F distribution with {it:n1}
	numerator and {it:n2} denominator degrees of freedom.{p_end}

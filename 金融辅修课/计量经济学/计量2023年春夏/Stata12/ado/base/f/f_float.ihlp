{* *! version 1.0.4  20oct2009}{...}
    {cmd:float(}{it:x}{cmd:)}
{p2colset 8 22 26 2}{...}
{p2col: Domain:}-1e+38 to 1e+38{p_end}
{p2col: Range:}-1e+38 to 1e+38{p_end}
{p2col: Description:}returns the value of {it:x} rounded
	to {cmd:float} precision.{p_end}

{p2col 8 22 22 2:}Although you may store your numeric variables as {cmd:byte},
...
{p2col 8 22 22 2:}For example, if the variable {cmd:x} is stored as a

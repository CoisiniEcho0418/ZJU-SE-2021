...
{cmd:floor(}{it:k}{cmd:)} or fewer outcomes that are 
distributed as Poisson with mean {it:m}.{p_end}

{p2col 8 22 22 2:}The Poisson distribution function is evaluated using 
the {cmd:gammaptail()} function.
{p2colreset}{...}

...
{p2colset 5 29 31 2}{...}
{p2col :{manlinki G-3 fcline_options} {hline 2}}Options for determining the look of fitted connecting lines{p_end}
{p2colreset}{...}
...
{p2col:{cmdab:clw:idth:(}{it:{help linewidthstyle}}{cmd:)}}thickness of line
     {p_end}
{p2col:{cmdab:clc:olor:(}{it:{help colorstyle}}{cmd:)}}color of line{p_end}

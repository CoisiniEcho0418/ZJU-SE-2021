...
{vieweralsosee "[R] fracpoly postestimation" "mansection R fracpolypostestimation"}{...}
{vieweralsosee "" "--"}{...}
...
{viewerjumpto "Syntax for fracplot and fracpred" "fracpoly postestimation##syntax_fracplot"}{...}
...
{p2colset 5 36 38 2}{...}
{p2col :{manlink R fracpoly postestimation} {hline 2}}Postestimation tools for
fracpoly{p_end}
{p2colreset}{...}

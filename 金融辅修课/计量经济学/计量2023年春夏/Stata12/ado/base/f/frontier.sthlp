...
{viewerjumpto "Saved results" "frontier##saved_results"}{...}
{viewerjumpto "Reference" "frontier##reference"}{...}
{title:Title}

{p2colset 5 21 23 2}{...}
{p2col :{manlink R frontier} {hline 2}}Stochastic frontier models{p_end}
{p2colreset}{...}
...
{pstd}
The following option is available with {opt frontier} but is not shown in the
dialog box:
...
{pstd}
{cmd:frontier} saves the following in {cmd:e()}:

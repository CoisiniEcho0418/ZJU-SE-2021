...
{viewerjumpto "Saved results" "glm##saved_results"}{...}
{viewerjumpto "Reference" "glm##reference"}{...}
{title:Title}

{p2colset 5 16 18 2}{...}
{p2col :{manlink R glm} {hline 2}}Generalized linear models{p_end}
{p2colreset}{...}
...
{p 4 6 2}
{opt noheader}, {opt notable}, {opt nodisplay}, and {opt coeflegend}
...
{pstd}
See {manhelp estimation_commands I:estimation commands} for a complete list of
...
{pstd}Generalized linear model with binomial family and cloglog link{p_end}
...
{pstd}
{cmd:glm, ml} saves the following in {cmd:e()}:
...
{pstd}
{cmd:glm, irls} saves the following in {cmd:e()}:

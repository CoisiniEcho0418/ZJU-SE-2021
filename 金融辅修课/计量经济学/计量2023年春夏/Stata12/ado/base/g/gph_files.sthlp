...
{p2colset 5 33 35 2}{...}
{p2col :{bf:{mansection G-4 conceptgphfiles:[G-4] concept: gph files}} {hline 2}}Using gph files{p_end}
{p2colreset}{...}
...
{pstd}
Live-format files contain the data and other information necessary to recreate
the graph.  As-is format files contain a recording of the picture.  When you
save a graph, unless you specify the {cmd:asis} option, it is saved in
live format.
...
different schemes; see {manhelp schemes G-4:scheme intro}.  Also, the
...
{txt}{p 12 15}
dta file:
{res}C:\Program Files\Stata12\ado\base\lifeexp.dta dated 26 Mar 2011 09:40
{p_end}
{txt}{p 13 15}
command:

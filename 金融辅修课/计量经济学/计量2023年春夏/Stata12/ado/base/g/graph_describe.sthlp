...
{viewerjumpto "Saved results" "graph_describe##saved_results"}{...}
{title:Title}

{p2colset 5 29 31 2}{...}
{p2col :{manlink G-2 graph describe} {hline 2}}Describe contents of graph in memory or on disk{p_end}
{p2colreset}{...}
...
{pstd}
{cmd:graph describe} saves the following in {cmd:r()}:

...
{p2colset 5 24 26 2}{...}
{p2col :{manlink G-2 graph set} {hline 2}}Set graphics options{p_end}
{p2colreset}{...}
...
exported to PostScript or Encapsulated PostScript files, use
{cmd:graph} {cmd:set} {c -(}{cmd:ps}|{cmd:eps}{c )-} {cmd:fontface}{it:*}; see
{manhelpi ps_options G-3} or {manhelpi eps_options G-3}.)  If {it:fontname}

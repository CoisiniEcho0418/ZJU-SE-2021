...
{p2colset 5 19 21 2}{...}
{p2col :{manlinki G-4 text} {hline 2}}Text in graphs{p_end}
{p2colreset}{...}
...
exported to PostScript and Encapsulated PostScript files.
...
{pstd}
In HTML, character entity references are all of the form

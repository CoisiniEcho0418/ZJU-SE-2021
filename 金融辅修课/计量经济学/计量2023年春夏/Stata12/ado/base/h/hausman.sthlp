...
{viewerjumpto "Remark: An alternative to hausman" "hausman##remark"}{...}
{viewerjumpto "Examples" "hausman##examples"}{...}
{viewerjumpto "Saved results" "hausman##saved_results"}{...}
{title:Title}

{p2colset 5 20 22 2}{...}
{p2col :{manlink R hausman} {hline 2}}Hausman specification test{p_end}
{p2colreset}{...}
...
{phang}
{bf:Statistics > Postestimation > Tests > Hausman specification test}
...
{pmore}
These options can be specified only when both estimators save {cmd:e(sigma)}
or {cmd:e(rmse)}, or with the {cmd:xtreg} command.  {cmd:e(sigma_e)} is saved
after the {cmd:xtreg} command with the {cmd:fe} or {cmd:mle} option.
{cmd:e(rmse)} is saved after the {cmd:xtreg} command with the {cmd:re} option.
...
{pstd}
{cmd:hausman} saves the following in {cmd:r()}:

{smcl}
{* *! version 1.2.8  10mar2011}{...}
{viewerdialog check "dialog icd9check"}{...}
{viewerdialog clean "dialog icd9clean"}{...}
{viewerdialog generate "dialog icd9generate"}{...}
{viewerdialog lookup "dialog icd9lookup"}{...}
{viewerdialog search "dialog icd9search"}{...}
{viewerdialog query "dialog icd9query"}{...}
...
{viewerjumpto "Saved results" "icd9##saved_results"}{...}
{title:Title}

{p2colset 5 17 19 2}{...}
{p2col :{manlink D icd9} {hline 2}}ICD-9-CM diagnostic and procedure codes{p_end}
{p2colreset}{...}
...
{pstd}
{opt icd9}[{opt p}] works with V28, V27, V26, V25, V24, V22, V21, V19, V18,
and V16 codes.
...
{phang2}{cmd:. icd9 generate main1 = diag1, main}{p_end}
...
{pstd}
{cmd:icd9} and {cmd:icd9p} save the following in {cmd:r()}:

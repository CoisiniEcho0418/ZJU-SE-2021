...
{viewerjumpto "Saved results" "irf_rename##saved_results"}{...}
{title:Title}

{p2colset 5 24 26 2}{...}
{p2col:{manlink TS irf rename} {hline 2}}Rename an IRF result in an IRF file{p_end}
{p2colreset}{...}
...
{pstd}
{opt irf rename} changes the name of a set of IRF results stored in the
active IRF file.
...
{pstd}
{cmd:irf rename} saves the following in {cmd:r()}:

...
{p2colset 5 19 21 2}{...}
{p2col :{manlink D joinby} {hline 2}}Form all pairwise combinations within groups{p_end}
{p2colreset}{...}
...
children from data at http://www.stata-press.com{p_end}
{phang2}{cmd:. joinby family_id using}
            {cmd:http://www.stata-press.com/data/r12/child}

...
{viewerjumpto "Saved results" "label##saved_results"}{...}
{title:Title}

{p2colset 5 18 20 2}{...}
{p2col :{manlink D label} {hline 2}}Manipulate labels{p_end}
{p2colreset}{...}
...
{p 8 15 2}
{opt la:bel} {opt val:ues} {varlist} [{it:lblname}|{cmd:.}] [{cmd:,} {cmd:nofix}]
...
acts the same as specifying the {cmd:.}.  Value labels may be up to 32,000
characters long.
...
{pstd}
{cmd:label list} saves the following in {cmd:r()}:
...
{pstd}
{cmd:label dir} saves the following in {cmd:r()}:

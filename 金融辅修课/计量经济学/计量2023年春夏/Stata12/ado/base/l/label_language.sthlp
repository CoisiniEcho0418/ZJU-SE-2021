...
{viewerjumpto "Saved results" "label_language##saved_results"}{...}
{title:Title}

{p2colset 5 27 29 2}{...}
{p2col :{manlink D label language} {hline 2}}Labels for variables and values in
...
{pstd}
{cmd:label language} without arguments saves the following in {cmd:r()}:

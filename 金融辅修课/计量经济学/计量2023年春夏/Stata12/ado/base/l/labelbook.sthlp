...
{viewerjumpto "Saved results" "labelbook##saved_results"}{...}
{title:Title}

{p2colset 5 22 24 2}{...}
{p2col :{manlink D labelbook} {hline 2}}Label utilities{p_end}
{p2colreset}{...}
...
{pstd}
{cmd:labelbook} saves the following in {cmd:r()}:
...
{pstd}
{cmd:uselabel} saves the following in {cmd:r()}:

{synoptset 20 tabbed}{...}
{p2col 5 20 24 2: Macros}{p_end}
{synopt:{cmd:r({it:lblname})}}list of variables that use value label

...
{phang}
{manlink M-2 errors} {hline 2} Error codes
...
{p 4 8 2}
3012. undefined operation on a pointer{break}
...
{p 4 8 2}
3612. file too large for 32-bit Stata{break}
    You are running 32-bit Stata on a 64-bit computer, and the file
    you wish to process is larger than 4 gigabytes.

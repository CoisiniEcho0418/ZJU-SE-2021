...
{phang}
{manlink M-2 syntax} {hline 2} Mata language grammar and syntax
...
(it is in fact a {bind:0 {it:x} 0} {cmd:real} {cmd:matrix}).  Since declarations

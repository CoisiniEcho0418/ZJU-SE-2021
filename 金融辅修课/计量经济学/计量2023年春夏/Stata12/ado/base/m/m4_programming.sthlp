...
{phang}
{manlink M-4 programming} {hline 2} Programming functions
...
{col 42}whether speed/space is to be favored
...
{col 42}query/reset white-space characters
...
{col 24}{cmd:hash1()}{...}
{col 42}Jenkins' one-at-a-time hash

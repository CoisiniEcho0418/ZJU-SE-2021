...
{phang}
{manlink M-5 intro} {hline 2} Mata functions
...
{p2col:{bf:{help mf_ascii:ascii()}}}row vector of ASCII codes of characters in a string{p_end}
...
{p2col:{bf:{help mf_normal:binomial()}}}cumulative of binomial (k or fewer successes){p_end}
{p2col:{bf:{help mf_normal:binomialp()}}}binomial probability mass function{p_end}
{p2col:{bf:{help mf_normal:binomialtail()}}}right cumulative of binomial (k or more successes){p_end}
{p2col:{bf:{help mf_normal:binormal()}}}cumulative of bivariate normal distribution{p_end}
...
{p2col:{bf:{help mf_eigensystemselect:eigensystemselectf()}}}right eigenvectors and eigenvalues selected by user-written function{p_end}
...
{p2col:{bf:{help mf_geigensystem:geigensystemselectf()}}}right gen. eigenvectors and eigenvalues selected by user-written function{p_end}
...
{p2col:{bf:{help mf_normal:invbinomial()}}}inverse binomial{p_end}
{p2col:{bf:{help mf_normal:invbinomialtail()}}}inverse upper-tail binomial {p_end}
...
{p2col:{bf:{help mf_normal:invnchi2()}}}inverse noncentral cumulative chi-squared{p_end}
...
{p2col:{bf:{help mf_invsym:invsym()}}}generalized inverse of real, positive-definite, symmetric matrix{p_end}
{p2col:{bf:{help mf_invtokens:invtokens()}}}string scalar containing concatenated string-vector elements {p_end}
{p2col:{bf:{help mf_normal:invttail()}}}inverse upper-tail-cumulative t{p_end}
...
{p2col:{bf:{help mf_eigensystemselect:lefteigensystemselectf()}}}left eigenvectors and eigenvalues selected by user-written function{p_end}
...
{p2col:{bf:{help mf_geigensystem:leftgeigensystemselectf()}}}left gen. eigenvectors and eigenvalues selected by user-written function{p_end}
...
{p2col:{bf:{help mf_normal:nbinomial()}}}negative binomial distribution function{p_end}
{p2col:{bf:{help mf_normal:nbinomialp()}}}negative binomial probability mass function{p_end}
{p2col:{bf:{help mf_normal:nbinomialtail()}}}right cumulative of the negative binomial distribution{p_end}
...
{p2col:{bf:{help mf_normal:npnchi2()}}}noncentrality parameter of {cmd:nchi2()}{p_end}
...
directories such as "UPDATES"{p_end}
...
{p2col:{bf:{help mf_normal:poisson()}}}Poisson distribution function{p_end}
{p2col:{bf:{help mf_normal:poissonp()}}}Poisson probability mass function{p_end}
{p2col:{bf:{help mf_normal:poissontail()}}}right cumulative of the Poisson distribution{p_end}
...
{p2col:{bf:{help mf_normal:ttail()}}}1 minus cumulative t distribution{p_end}

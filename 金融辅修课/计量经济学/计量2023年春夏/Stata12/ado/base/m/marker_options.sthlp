...
{p2colset 5 29 31 2}{...}
{p2col :{manlinki G-3 marker_options} {hline 2}}Options for specifying markers{p_end}
{p2colreset}{...}
...
{p2col:{cmdab:mc:olor:(}{it:{help colorstyle}}{cmd:)}}color of marker, inside
       and out{p_end}
...
{p2col:{cmdab:mlc:olor:(}{it:{help colorstyle}}{cmd:)}}outline color{p_end}

...
{p2colset 5 31 33 2}{...}
{p2col :{manlinki G-4 markerlabelstyle} {hline 2}}Choices for overall look of marker labels{p_end}
{p2colreset}{...}
...
{pstd}
The look of marker labels is defined by four attributes:
...
{pstd}
The {it:markerlabelstyle} specifies all four of these attributes.

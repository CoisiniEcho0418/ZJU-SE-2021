...
{p2colset 5 30 32 2}{...}
{p2col :{manlinki G-4 markersizestyle} {hline 2}}Choices for the size of markers{p_end}
{p2colreset}{...}
...
{p2col:{it:{help relativesize}}}any size you want, including size modification{p_end}
{p2line}
{p2colreset}{...}

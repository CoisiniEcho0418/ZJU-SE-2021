...
{p2colset 5 33 35 2}{...}
{p2col:{manlink P matrix dissimilarity} {hline 2}}Compute similarity or
...
{pstd}
If there are many observations (variables when the
{cmd:variables} option is specified), you may need to increase the maximum
matrix size; see {manhelp matsize R}.  If the number of observations (or
...
similarities or dissimilarities in variables; see

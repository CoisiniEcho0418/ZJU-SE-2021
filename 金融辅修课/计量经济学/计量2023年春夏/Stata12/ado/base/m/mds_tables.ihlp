...
{synopt:{opt t:arget(matname)}[{cmd:, }{opt c:opy}]}Procrustes rotation toward {it:matname}; ignore naming conflicts if {cmd:copy} is specified{p_end}
{synoptline}
...
{synopt:{opt f:rom(matname)}[{cmd:, }{opt c:opy}]}start from

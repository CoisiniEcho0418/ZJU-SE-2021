...
{p2colset 5 28 30 2}{...}
{p2col:{manlinki MV measure_option} {hline 2}}Option for similarity and
...
{pstd}
Measures are divided into those for continuous data, binary data, and a mix of
continuous and binary measures.
...
requests the {help measure_option##K1927:Kulczynski (1927)} binary similarity
coefficient
...
{pmore}
where delta_ijv is a binary indicator equal to one whenever both observations
...
when all of the values of delta_ijv or delta_iuv are zero.  The dissimilarity
...
{marker K1927}{...}
{phang}
Kulczynski, S. 1927. Die Pflanzenassoziationen der Pieninen [In Polish,

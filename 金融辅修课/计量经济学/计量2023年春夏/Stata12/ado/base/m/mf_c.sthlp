...
{viewerjumpto "Syntax" "mf_c##syntax"}{...}
{viewerjumpto "Description" "mf_c##description"}{...}
{viewerjumpto "Remarks" "mf_c##remarks"}{...}
{viewerjumpto "Conformability" "mf_c##conformability"}{...}
{viewerjumpto "Diagnostics" "mf_c##diagnostics"}{...}
{viewerjumpto "Source code" "mf_c##source"}{...}
{title:Title}

{p 4 8 2}
{manlink M-5 C()} {hline 2} Make complex

...
{p 4 8 2}
{manlink M-5 geigensystem()} {hline 2} Generalized eigenvectors and eigenvalues
...
generalized eigenvalues are computed.  Generalized eigenvalues are selected by a
user-written function described {help mf_geigensystem##criterion:below}.

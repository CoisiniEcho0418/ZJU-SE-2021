...
might be longer than 67,784 characters.
...
{p 4 4 2}
The maximum length of a characteristic is 67,784 characters whether you are
running {help stataic:Stata/IC}, {help specialedition:Stata/SE}, or
{help statamp:Stata/MP}.  In Stata/SE and Stata/MP, however, macros can be
...
The maximum length of a characteristic is 67,784 characters.  Macros are
longer than that when the user is running {help SpecialEdition:Stata/SE} or
{help statamp:Stata/MP}.  How much longer macros can be depends on
...
{p 4 4 2}
In regular Stata/IC, the maximum number of variables is 2,047.
Variable names can be 32 characters, so macros must allow at least 
2,047*33 = 67,551 characters.

{p 4 4 2}
In Stata/SE and Stata/MP, the maximum number of variables is 5,000 by 
default and can be set up to 32,767.  Thus, the maximum length 
of macros must allow at least 5,000*33 = 165,000 to 32,767*33 = 1,081,311
characters.  Yet, in all these cases, the maximum length of a 
characteristic remains fixed at 67,784 characters, meaning that
saving all the variable names in one characteristic is not generally possible.

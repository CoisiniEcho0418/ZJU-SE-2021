...
{viewerjumpto "Description" "mgarch ccc postestimation##description"}{...}
{viewerjumpto "Syntax for predict" "mgarch ccc postestimation##syntax_predict"}{...}
{viewerjumpto "Options for predict" "mgarch ccc postestimation##options_predict"}{...}
{viewerjumpto "Examples" "mgarch ccc postestimation##examples"}{...}
{title:Title}

{p2colset 5 39 43 2}{...}
{p2col :{manlink TS mgarch ccc postestimation} {hline 2}}Postestimation tools

...
{viewerjumpto "Saved results" "mgarch vcc##saved_results"}{...}
{viewerjumpto "Reference" "mgarch vcc##reference"}{...}
{title:Title}

{synoptset 17}{...}
{synopt:{manlink TS mgarch vcc} {hline 2}}Varying conditional correlation
...
{phang2}
          ...
          [{cmd:,} {it:{help mgarch_vcc##eqoptions:eqoptions}}]{cmd:)}
...
{pstd}
{cmd:mgarch vcc} saves the following in {cmd:e()}:

...
{viewerjumpto "Description" "mgarch vcc postestimation##description"}{...}
{viewerjumpto "Syntax for predict" "mgarch vcc postestimation##syntax_predict"}{...}
{viewerjumpto "Options for predict" "mgarch vcc postestimation##options_predict"}{...}
{viewerjumpto "Examples" "mgarch vcc postestimation##examples"}{...}
{title:Title}

{p2colset 5 39 43 2}{...}
{p2col :{manlink TS mgarch vcc postestimation} {hline 2}}Postestimation tools
for mgarch vcc{p_end}
...
{synopt :{helpb mgarch vcc postestimation##predict:predict}}predictions, residuals, influence statistics, and other diagnostic measures{p_end}

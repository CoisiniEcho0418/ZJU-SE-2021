...
{viewerjumpto "Saved results" "mi_impute_mlogit##saved_results"}{...}
{title:Title}

{p2colset 5 30 32 2}{...}
{p2col :{manlink MI mi impute mlogit} {hline 2}}Impute using multinomial logistic regression{p_end}
{p2colreset}{...}
...
{pstd}
{cmd:mi impute mlogit} saves the following in {cmd:r()}:

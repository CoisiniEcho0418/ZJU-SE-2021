...
{viewerjumpto "Saved results" "mi_impute_poisson##saved_results"}{...}
{title:Title}

{p2colset 5 31 33 2}{...}
{p2col :{manlink MI mi impute poisson} {hline 2}}Impute using Poisson regression{p_end}
{p2colreset}{...}
...
variable using the Poisson regression imputation method.  You can perform
...
{pstd}
{cmd:mi impute poisson} saves the following in {cmd:r()}:

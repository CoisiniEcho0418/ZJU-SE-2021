...
{p2colset 5 23 25 2}{...}
{p2col :{manlink MI technical} {hline 2}}Details for programmers{p_end}
{p2colreset}{...}
...
{pstd}
See {mansection P programpropertiesRemarksWritingprogramsforusewithmi:{it:Writing programs for use with mi}} of [P] {bf:program properties}

...
{viewerjumpto "Saved results" "ml##saved_results"}{...}
{viewerjumpto "References" "ml##references"}{...}
{title:Title}

{p2colset 4 14 16 2}{...}
{p2col:{manlink R ml} {hline 2}}Maximum likelihood estimation{p_end}
{p2colreset}{...}
...
and {cmd:svy} will work with method lf, lf0, lf1, lf2, and gf0 evaluators;
...
{mansection R mlOptionsforusewithmlmodelininteractiveornoninteractivemodenopreserve:{bf:nopreserve}}
...
{pmore}
for instance, {cmd:bounds(xb 100 100 lnsigma 0 10)}.  The {opt ml model}
...
the number of equations.  The evaluators of method g0, k is the number of
parameters.  If {opt score(stub*)} is specified, variables named
...
{pmore}
For method gf0, the first variable contains {bind:d(ln l_j)/d(b_1)}, the

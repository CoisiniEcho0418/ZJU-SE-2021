...
{viewerjumpto "Description" "oprobit postestimation##description"}{...}
{viewerjumpto "Syntax for predict" "oprobit postestimation##syntax_predict"}{...}
{viewerjumpto "Options for predict" "oprobit postestimation##options_predict"}{...}
{viewerjumpto "Examples" "oprobit postestimation##examples"}{...}
{title:Title}

{p2colset 5 35 37 2}{...}
{p2col :{manlink R oprobit postestimation} {hline 2}}Postestimation tools for oprobit{p_end}
{p2colreset}{...}
...
{cmd:oprobit result x1 x2}, and {opt result} takes on three values.

...
{p2colset 5 19 21 2}{...}
{p2col :{manlink R pksumm} {hline 2}}Summarize pharmacokinetic data{p_end}
{p2colreset}{...}
...
situations.  When the curve is irregular, the trapezoidal
...
is {cmd:fit(3)}, the last three points.  This default should be viewed as a
minimum; the appropriate number of points will depend on the data.
...
{cmd:pksumm} should graph.  The default is {cmd:stat(auc)}.  If the {opt graph}
option is not specified, this option is ignored.

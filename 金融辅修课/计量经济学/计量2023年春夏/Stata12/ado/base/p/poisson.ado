*! version 3.6.7  03feb2011
program poisson, eclass byable(onecall) prop(irr ml_score svyb svyj svyr swml mi)
	if _by() {
...
/* Parse. */
	...
	*/ SCore(string) noLOg noDISPLAY CRITTYPE(passthru) MATAevaluator * ]

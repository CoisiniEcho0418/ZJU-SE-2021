...
{vieweralsosee "" "--"}{...}
{vieweralsosee "[I] postestimation commands" "help postestimation_commands"}{...}
{vieweralsosee "" "--"}{...}
{vieweralsosee "[P] ereturn" "help ereturn"}{...}
{viewerjumpto "Description" "postest##description"}{...}
{viewerjumpto "Examples" "postest##examples"}{...}
{title:Title}
...
{pstd}
Estimation commands save results in {hi:e()}.  These saved results

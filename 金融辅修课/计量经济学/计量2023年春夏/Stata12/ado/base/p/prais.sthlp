...
{viewerjumpto "Saved results" "prais##saved_results"}{...}
{viewerjumpto "References" "prais##references"}{...}
{title:Title}

{p2colset 5 19 21 2}{...}
{p2col:{manlink TS prais} {hline 2}}Prais-Winsten and Cochrane-Orcutt regression{p_end}
{p2colreset}{...}
...
{pmore}
{cmd:prais} also allows the following:
...
{pstd}
{cmd:prais} saves the following in {cmd:e()}:

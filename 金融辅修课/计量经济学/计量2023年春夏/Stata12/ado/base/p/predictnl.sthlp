...
{p2colset 5 22 24 2}{...}
{p2col :{manlink R predictnl} {hline 2}}Obtain nonlinear predictions, standard
...
{phang}
{bf:Statistics > Postestimation > Nonlinear predictions}
...
See {mansection R predictnlRemarks:{it:Remarks}} in {bf:[R] predictnl} for
examples that use both of these functions.
...
(for example, as standard errors) will be correct or that the values obtained
can be interpreted.

...
{viewerjumpto "Description" "procrustes postestimation##description"}{...}
{viewerjumpto "Special-interest postestimation commands" "procrustes postestimation##special"}{...}
{viewerjumpto "" "--"}{...}
{viewerjumpto "Syntax for predict" "procrustes postestimation##syntax_predict"}{...}
{viewerjumpto "Options for predict" "procrustes postestimation##options_predict"}{...}
{viewerjumpto "" "--"}{...}
{viewerjumpto "Syntax for estat" "procrustes postestimation##syntax_estat"}{...}
{viewerjumpto "Options for estat" "procrustes postestimation##options_estat"}{...}
{viewerjumpto "" "--"}{...}
{viewerjumpto "Syntax for procoverlay" "procrustes postestimation##syntax_procoverlay"}{...}
{viewerjumpto "Options for procoverlay" "procrustes postestimation##options_procoverlay"}{...}
{viewerjumpto "" "--"}{...}
{viewerjumpto "Examples" "procrustes postestimation##examples"}{...}
{viewerjumpto "Saved results" "procrustes postestimation##saved_results"}{...}
{title:Title}

{p 4 40 2}
{manlink MV procrustes postestimation} {hline 2} Postestimation tools for
{cmd:procrustes}
...
{p 8 16 2}
{cmd:predict} {dtype} {{it:stub}{cmd:*}|{newvar:list}} {ifin} [{cmd:,}
	{it:statistic} ]
...
allowed by {cmd:mvreg}; see {manhelp mvreg R}.  The constant is already
suppressed if the Procrustes analysis suppressed it.

{phang}
{opt labels}, {opt noheader}, and {opt noweights} are the same as for the
generic {cmd:estat} {cmd:summarize} command; see {manhelp estat R}.
...
{manhelp marker_label_options G-3}.
...
{pstd}
{cmd:estat compare} after {cmd:procrustes} saves the following in {cmd:r()}:
...
{pstd}
{cmd:estat summarize} after {cmd:procrustes} saves the following in {cmd:r()}:

...
{viewerjumpto "Saved results" "putmata##saved_results"}{...}
{title:Title}

{p2colset 5 20 22 2}{...}
{p2col:{manlink D putmata} {hline 2}}Put Stata variables into Mata and vice versa
{p_end}
{p2colreset}{...}
...
wish to post back to Mata.  We will use both {cmd:putmata} and {cmd:getmata}.
...
{p 4 4 2}
{cmd:putmata} saves the following in {cmd:r()}:
...
{p 4 4 2}
{cmd:getmata} saves the following in {cmd:r()}:

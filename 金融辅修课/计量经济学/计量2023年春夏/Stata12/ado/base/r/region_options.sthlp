...
{p2colset 5 29 31 2}{...}
{p2col :{manlinki G-3 region_options} {hline 2}}Options for shading and outlining regions and controlling graph size{p_end}
{p2colreset}{...}
...
{p2line}
{p2col:{cmdab:ysiz:e:(}{it:#}{cmd:)}}height of {it:available area} (in inches)
     {p_end}
{p2col:{cmdab:xsiz:e:(}{it:#}{cmd:)}}width of {it:available area} (in inches)
     {p_end}
...
{p2col:{cmdab:c:olor:(}{it:{help colorstyle}}{cmd:)}}line and fill color of
       outer region{p_end}
{p2col:{cmdab:fc:olor:(}{it:{help colorstyle}}{cmd:)}}fill color of outer
       region{p_end}
{p2col:{cmdab:ls:tyle:(}{it:{help linestyle}}{cmd:)}}overall style of outline
       {p_end}
{p2col:{cmdab:lc:olor:(}{it:{help colorstyle}}{cmd:)}}color of outline{p_end}
...
{p2col:{cmdab:isty:le:(}{it:{help areastyle}}{cmd:)}}overall style of inner
      region{p_end}
{p2col:{cmdab:ic:olor:(}{it:{help colorstyle}}{cmd:)}}line and fill color of
      inner region{p_end}
{p2col:{cmdab:ifc:olor:(}{it:{help colorstyle}}{cmd:)}}fill color of inner
      region{p_end}
{p2col:{cmdab:ils:tyle:(}{it:{help linestyle}}{cmd:)}}overall style of
       outline{p_end}
{p2col:{cmdab:ilc:olor:(}{it:{help colorstyle}}{cmd:)}}color of outline{p_end}
...
{cmd:ysize(}{it:#}{cmd:)} and {cmd:xsize(}{it:#}{cmd:)}
    ...
    course, is controlled by the scheme; see
...
with
	...
	{cmd:. scatter mpg weight, ysize(5)}
	  {it:({stata "gr_example auto: scatter mpg weight, ysize(4.5)":click to run})}
{* graph regopts3}{...}

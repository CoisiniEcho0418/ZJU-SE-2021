...
{p2colset 5 16 18 2}{...}
{p2col:{manlink R roc} {hline 2}}Receiver operating characteristic (ROC) analysis
{p_end}
{p2colreset}{...}
...
it is an estimation command.  In postestimation, graphs of the ROC
...
the false-positive rate.  In the second stage, the ROC curve is 
...
covariate effect.  Both parametric (semiparametric) and nonparametric methods
...
book
({browse "http://www.stata.com/bookstore/pepe.html":http://www.stata.com/bookstore/pepe.html}).

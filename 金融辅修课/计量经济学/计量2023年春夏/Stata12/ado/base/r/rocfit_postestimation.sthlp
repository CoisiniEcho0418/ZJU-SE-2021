...
{viewerjumpto "Description" "rocfit postestimation##description"}{...}
{viewerjumpto "Special-interest postestimation commands" "rocfit postestimation##special"}{...}
{viewerjumpto "Syntax for rocplot" "rocfit postestimation##syntax_rocplot"}{...}
{viewerjumpto "Options for rocplot" "rocfit postestimation##options_rocplot"}{...}
{viewerjumpto "Examples" "rocfit postestimation##examples"}{...}
{title:Title}

{p2colset 5 34 36 2}{...}
{p2col:{manlink R rocfit postestimation} {hline 2}}Postestimation tools for rocfit{p_end}
{p2colreset}{...}
...
{p 4 6 2}
* See 
{mansection R rocfitpostestimationRemarksUsinglincomandtest:{it:Using lincom and test}} in {bf:[R] rocfit postestimation}.

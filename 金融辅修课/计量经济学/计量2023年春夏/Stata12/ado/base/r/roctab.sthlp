...
{viewerjumpto "Saved results" "roctab##saved_results"}{...}
{viewerjumpto "References" "roctab##references"}{...}
{title:Title}

{p2colset 5 19 21 2}{...}
{p2col:{manlink R roctab} {hline 2}}Nonparametric ROC analysis
{p_end}
{p2colreset}{...}
...
{pstd}
{cmd:roctab} saves the following in {cmd:r()}:

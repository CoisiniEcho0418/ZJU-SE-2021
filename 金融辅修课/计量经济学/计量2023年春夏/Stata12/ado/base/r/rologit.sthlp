{smcl}
{* *! version 1.3.19  03may2011}{...}
{viewerdialog rologit "dialog rologit"}{...}
{vieweralsosee "[R] rologit" "mansection R rologit"}{...}
{vieweralsosee "" "--"}{...}
...
{viewerjumpto "Saved results" "rologit##saved_results"}{...}
{viewerjumpto "References" "rologit##references"}{...}
{title:Title}

{p2colset 5 20 22 2}{...}
{p2col :{manlink R rologit} {hline 2}}Rank-ordered logistic regression{p_end}
{p2colreset}{...}
...
{pstd}
{cmd:rologit} saves the following in {cmd:e()}:

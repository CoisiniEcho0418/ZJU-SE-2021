...
// generates a orthogonal matrix T that is derived from a random perturbation
...
// generates a oblique matrix T that is derived from a random perturbation
// of T0 with Uniform(-a,a)
...
//
// options pargs specify how repeated minization attempts are made from
...
program Minimize, rclass
	...
	// uprotected run: optimize from "initial" starting vals T and return
...
// criteria commands
//
// Syntax   Citerion todo q Gq = L options
//
...
// reorder colums to be of nonincreasing norm
program Order
	args AT T p 

...
{p2colset 5 29 31 2}{...}
{p2col:{manlinki G-3 rspike_options} {hline 2}}Options for determining the look of range spikes{p_end}
{p2colreset}{...}
...
{p2col:{cmdab:lw:idth:(}{it:{help linewidthstyle}}{cmd:)}}thickness of spike
      line{p_end}
{p2col:{cmdab:lc:olor:(}{it:{help colorstyle}}{cmd:)}}color of spike line{p_end}
...
{cmd:lcolor(}{it:colorstyle}{cmd:)}
    specifies the color of the line for the spike.  See

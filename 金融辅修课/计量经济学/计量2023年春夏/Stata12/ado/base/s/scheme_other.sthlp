...
Stata.  Some, however, may be referenced by user-written schemes or if a plot
is {help advanced_options:recast} from one type to another.
...
{it:{help relativesize:relativesizes}} may be used for these entries.

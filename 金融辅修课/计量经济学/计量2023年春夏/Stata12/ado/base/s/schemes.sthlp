...
{p2colset 5 28 30 2}{...}
{p2col :{manlink G-4 schemes intro} {hline 2}}Introduction to schemes{p_end}
{p2colreset}{...}
...
{col 22}color{...}
{col 36}black{...}
{col 48}a plain look on black background
{...}
...
{col 22}monochrome{...}
{col 36}white{...}
{col 48}a plain look in monochrome
{...}
	{bf:{help scheme s1:s1manual}}{...}
{col 22}monochrome{...}
{col 36}white{...}
{col 48}a plain look, but smaller;
...
{it:{browse "http://www.economist.com":The Economist}}
magazine (http://www.economist.com) , whose graphs we believe to be worthy of
...
to you.  To search the Internet, type
	...
	{cmd:.} {bf:{search scheme, all:findit scheme}}
...
you; see {cmd:findit} in {manhelp search R}.

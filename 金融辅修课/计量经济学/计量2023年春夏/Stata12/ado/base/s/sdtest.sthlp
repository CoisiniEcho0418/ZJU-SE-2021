...
{viewerdialog "one-sample sdtest" "dialog sdtest1"}{...}
{viewerdialog "two-sample sdtest" "dialog sdtest2"}{...}
{viewerdialog "two-sample, by()" "dialog sdtestby"}{...}
{viewerdialog "" "--"}{...}
{viewerdialog "one-sample sdtesti" "dialog sdtesti1"}{...}
{viewerdialog "two-sample sdtesti" "dialog sdtesti2"}{...}
{viewerdialog "" "--"}{...}
...
{viewerjumpto "Saved results" "sdtest##saved_results"}{...}
{viewerjumpto "References" "sdtest##references"}{...}
{title:Title}

{p2colset 5 19 21 2}{...}
{p2col:{manlink R sdtest} {hline 2}}Variance-comparison tests{p_end}
{p2colreset}{...}
...
{bf:Statistics > Summaries, tables, and tests >}
       {bf:Classical tests of hypotheses > One-sample variance-comparison test}

    {title:two-sample}

{phang2}
{bf:Statistics > Summaries, tables, and tests >}
        {bf:Classical tests of hypotheses > Two-sample variance-comparison test}

    {title:two-group}

{phang2}
{bf:Statistics > Summaries, tables, and tests >}
        {bf:Classical tests of hypotheses > Two-group variance-comparison test}
...
{bf:Statistics > Summaries, tables, and tests >}
        ...
        {bf:One-sample variance-comparison calculator}
...
{bf:Statistics > Summaries, tables, and tests >}
         {bf:Classical tests of hypotheses >}
         {bf:Two-sample variance-comparison calculator}
...
{varname} is {it:#}.
In the second form, {opt sdtest} tests that {it:varname1} and {it:varname2}
...
was found to be robust under nonnormality.  Subsequently, 
...
{pstd}
{cmd:sdtest} and {cmd:sdtesti} save the following in {cmd:r()}:
...
{pstd}
{cmd:robvar} saves the following in {cmd:r()}:

...
{vieweralsosee "[SEM] intro 3" "mansection SEM intro3RemarksStartingvalues"}{...}
{vieweralsosee "[SEM] sem path notation" "help sem_path_notation##initialvalues"}{...}
...
{it:{mansection SEM intro3RemarksStartingvalues:Starting values}} in
{manlink SEM intro 3} for advice on selecting initial values.
{p_end}

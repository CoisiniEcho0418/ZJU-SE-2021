...
{p2colset 5 25 27 2}{...}
{p2col :{manlinki G-4 shadestyle} {hline 2}}Choices for overall look of filled areas{p_end}
{p2colreset}{...}
...
{phang2}
    2.  {it:intensity} -- the intensity of the color; {break}
...
{pstd}
        ...
        {it:{help colorstyle}} and {help intensitystyle:intensity}.
{p_end}

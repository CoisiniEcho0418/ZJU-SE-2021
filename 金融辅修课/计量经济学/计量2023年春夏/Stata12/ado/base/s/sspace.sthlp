...
{viewerjumpto "Saved results" "sspace##saved_results"}{...}
{viewerjumpto "References" "sspace##references"}{...}
{title:Title}

{p2colset 5 20 24 2}{...}
{p2col :{manlink TS sspace} {hline 2}}State-space models{p_end}
{p2colreset}{...}
...
{phang}
{bf:Statistics > State-space models}
...
{pstd}
{cmd:sspace} saves the following in {cmd:e()}:

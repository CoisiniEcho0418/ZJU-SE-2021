...
{viewerjumpto "Description" "sspace postestimation##description"}{...}
{viewerjumpto "Syntax for predict" "sspace postestimation##syntax_predict"}{...}
{viewerjumpto "Options for predict" "sspace postestimation##options_predict"}{...}
{viewerjumpto "Examples" "sspace postestimation##examples"}{...}
{title:Title}

{p2colset 5 35 37 2}{...}
{p2col :{manlink TS sspace postestimation} {hline 2}}Postestimation tools for
sspace{p_end}
...
{synopt :{cmd:rmse(}{it:stub}{cmd:*}{c |}{it:{help newvarlist}}{cmd:)}}put

...
{p2colset 5 20 22 2}{...}
{p2col :{manlink D statsby} {hline 2}}Collect statistics for a command across a by list{p_end}
{p2colreset}{...}
...
dot character is printed for each by-group. A red `x'
...
{opt forcedrop} forces {cmd:statsby} to drop all
        ...
        commands that completely ignore {bf:{help if}} and {bf:{help in}} but
...
{title:Example: Collecting results saved in r-class macros}

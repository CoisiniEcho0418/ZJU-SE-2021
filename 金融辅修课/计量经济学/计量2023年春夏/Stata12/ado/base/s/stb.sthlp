...
{viewerjumpto "Obtaining user-written additions from the STB" "stb##software"}{...}
...
free from our website {browse "http://www.stata.com"}.
...
{browse "http://www.stata-journal.com":Stata Journal}, which began publication
...
{marker software}{...}
{title:Obtaining user-written additions from the STB}

{pstd}
The STB user-written additions are easily obtained.
You can {net "from http://www.stata.com/stb":click here}
...
Or use the command line and type
	    ...
	    {inp:. net from http://www.stata.com/stb}
...
website:  {browse "http://www.stata.com/bookstore/stbj.html"}.
...
STB Reprints are available from StataCorp.
	    ...
	    {browse "http://www.stata.com/bookstore/stbr.html"}

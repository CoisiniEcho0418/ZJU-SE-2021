...
{viewerjumpto "Saved results" "stci##saved_results"}{...}
{title:Title}

{p2colset 5 18 20 2}{...}
{p2col :{manlink ST stci} {hline 2}}Confidence intervals for means and percentiles of survival time{p_end}
...
{pstd}
{cmd:stci} saves the following in {cmd:r()}:

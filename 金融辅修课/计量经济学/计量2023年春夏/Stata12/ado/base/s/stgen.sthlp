...
{p2colset 5 19 21 2}{...}
{p2col :{manlink ST stgen} {hline 2}}Generate variables reflecting entire histories{p_end}
{p2colreset}{...}
...
entire histories -- variables you could create for yourself by using
{helpb generate} (and especially, {cmd:generate} with the {helpb by}
{varlist}{cmd::} prefix), but that would require too much thought, and there
...
reduces to one {cmd:generate}, and {cmd:generate} would be a more natural

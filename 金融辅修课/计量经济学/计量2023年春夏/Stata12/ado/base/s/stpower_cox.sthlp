{smcl}
{* *! version 1.1.11  07apr2011}{...}
{viewerdialog "stpower cox" "dialog stpower_cox"}{...}
{vieweralsosee "[ST] stpower cox" "mansection ST stpowercox"}{...}
{vieweralsosee "" "--"}{...}
...
{viewerjumpto "Saved results" "stpower_cox##saved_results"}{...}
{viewerjumpto "References" "stpower_cox##references"}{...}
{title:Title}

{p2colset 5 25 27 2}{...}
{p2col :{manlink ST stpower cox} {hline 2}}Sample size, power, and effect size for the Cox proportional hazards model{p_end}
{p2colreset}{...}
...
{help stpower_cox##examples:Examples} below, {manlink ST stpower}, and
...
{mansection ST stpowercoxMethodsandformulas:{it:Methods and formulas}} in
{bf:[ST] stpower cox} for the formulas used in the computation.
...
{p_end}
{phang2}
{cmd:. stpower cox -1, n(150) sd(0.3) failprob(0.8) r2(0.3)}
{p_end}
...
{p_end}
{phang2}
{cmd:. stpower cox, n(150) power(0.9) sd(0.3) failprob(0.8) r2(0.3)}
{p_end}
...
{pstd}
{cmd:stpower cox} saves the following in {cmd:r()}:

...
{viewerjumpto "Saved results" "stptime##saved_results"}{...}
{title:Title}

{p2colset 5 21 23 2}{...}
{p2col :{manlink ST stptime} {hline 2}}Calculate person-time, incidence rates, and SMR{p_end}
{p2colreset}{...}
...
{phang2}{cmd:. stptime, smr(ageband rate)}
          {cmd:using(http://www.stata-press.com/data/r12/smrchd) per(1000)}
...
{pstd}
{cmd:stptime} saves the following in {cmd:r()}:

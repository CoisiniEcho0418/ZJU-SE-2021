...
{p2colset 5 19 21 2}{...}
{p2col :{manlink ST stset} {hline 2}}Declare data to be survival-time data{p_end}
{p2colreset}{...}
...
{pmore}
     ...
     {mansection ST stsetRemarksex10:example 10} in {bf:[ST] stset}.

{pmore}
     {cmd:origin()} is an important concept; see
     {mansection ST stsetRemarksKeyconcepts:{it:Key concepts}},
     {mansection ST stsetRemarksTwoconceptsoftime:{it:Two concepts of time}},
     and
     {mansection ST stsetRemarksThesubstantivemeaningofanalysistime:{it:The substantive meaning of analysis time}}
     in {bf:[ST] stset}.
...
{mansection ST stsetRemarksif()versusifexp:{it:if() versus if exp}} in
{bf:[ST] stset}.
...
record.  See 
{mansection ST stsetRemarksIntermediateexitandreentrytimes(gaps):{it:Intermediate exit and reentry times (gaps)}}
in {bf:[ST] stset}.
...
sample.  See
{mansection ST stsetRemarksPastandfuturerecords:{it:Past and future records}}

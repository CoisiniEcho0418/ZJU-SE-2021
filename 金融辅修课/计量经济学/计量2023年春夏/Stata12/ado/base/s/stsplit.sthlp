...
{p2colset 5 21 23 2}{...}
{p2col :{manlink ST stsplit} {hline 2}}Split and join time-span records{p_end}
{p2colreset}{...}
...
{mansection ST stsplitRemarksex4:example 4} in {bind:{bf:[ST] stsplit}}.
...
{phang2}{cmd:. cf _all using http://www.stata-press.com/data/r12/diet, all}
{p_end}

...
{p2colset 5 22 24 2}{...}
{p2col:{manlink R sunflower} {hline 2}}Density-distribution sunflower plots{p_end}
{p2colreset}{...}
...
({help sunflower##PD2003:Plummer and Dupont 2003}).  These plots are useful for
displaying bivariate data whose density is too great for conventional
scatterplots to be effective.
...
{pstd}
The plane defined by the variables {it:yvar} and {it:xvar} is
divided into contiguous hexagonal bins.  The number of observations contained
within a bin determines how the bin will be represented.

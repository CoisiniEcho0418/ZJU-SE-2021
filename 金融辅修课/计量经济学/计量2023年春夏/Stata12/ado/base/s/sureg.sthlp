...
{viewerjumpto "Saved results" "sureg##saved_results"}{...}
{viewerjumpto "References" "sureg##references"}{...}
{title:Title}

{synoptset 11}{...}
{synopt:{manlink R sureg} {hline 2}}Zellner's seemingly unrelated regression{p_end}
{p2colreset}{...}
...
{varlist:1} [{cmd:,} {opt noc:onstant}]{cmd:)}{p_end}
{p 14 14 2}
{cmd:(}[{it:eqname2}{cmd::}] {depvar:2a} [{depvar:2b} ... {cmd:=}]
{varlist:2} [{cmd:,} {opt noc:onstant}]{cmd:)}{p_end}
{p 14}{it:...}{p_end}
{p 14 14 2}
{cmd:(}[{it:eqnameN}{cmd::}] {depvar:Na} [{depvar:Nb} ... {cmd:=}]
{varlist:N} [{cmd:,} {opt noc:onstant}]{cmd:)}
...
{pstd}
{cmd:sureg} saves the following in {cmd:e()}:
...
{synopt:{cmd:e(df_r)}}total residual degrees of freedom{p_end}
...
{synopt:{cmd:e(df_bp)}}degrees of freedom for Breusch-Pagan chi-squared
	test{p_end}
{synopt:{cmd:e(cons_}{it:#}{cmd:)}}{cmd:1} when equation {it:#} has a constant;
       {cmd:0}, otherwise{p_end}
...
{synopt:{cmd:e(dfk)}}alternate divisor ({cmd:dfk} or {cmd:dfk2} only){p_end}

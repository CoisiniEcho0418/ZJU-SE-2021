...
{viewerjumpto "Saved results" "svy_brr##saved_results"}{...}
{title:Title}

{p2colset 5 22 26 2}{...}
{p2col :{manlink SVY svy brr} {hline 2}}Balanced repeated replication for survey
data{p_end}
{p2colreset}{...}
...
{cmd:svy brr} saves the following in {cmd:e()}:

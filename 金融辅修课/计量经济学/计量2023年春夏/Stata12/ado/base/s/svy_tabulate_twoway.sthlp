...
{viewerjumpto "Saved results" "svy_tabulate_twoway##saved_results"}{...}
{viewerjumpto "References" "svy_tabulate_twoway##references"}{...}
{title:Title}

{p2colset 5 35 37 2}{...}
{p2col :{bf:{mansection SVY svytabulatetwoway:[SVY] svy: tabulate twoway}} {hline 2}}Two-way
...
relative to (that is, weighted by) this variable.  For example, if this variable
...
survey design by using the same correction procedure that is used with
...
the degrees of freedom of the variance estimates (the number of PSUs minus the
...
used for inference unless it is essentially identical to the adjusted
statistic.
...
(the default) can produce anti-conservative p-values, especially for sparse
...
{cmd:svy: tabulate} saves the following in {cmd:e()}:

{synoptset 15 tabbed}{...}
{p2col 5 15 19 2: Scalars}{p_end}
{synopt:{cmd:e(r)}}number of rows{p_end}
{synopt:{cmd:e(c)}}number of columns{p_end}
{synopt:{cmd:e(cvgdeff)}}c.v. of generalized DEFF eigenvalues{p_end}

...
{viewerjumpto "Saved results" "symmetry##saved_results"}{...}
{viewerjumpto "References" "symmetry##references"}{...}
{title:Title}

{p2colset 5 21 23 2}{...}
{p2col:{manlink R symmetry} {hline 2}}Symmetry and marginal homogeneity tests
{p_end}
{p2colreset}{...}
...
test produces an exact McNemar test; see {manhelp epitab ST}.  For many
...
{pstd}
{cmd:symmetry} saves the following in {cmd:r()}:

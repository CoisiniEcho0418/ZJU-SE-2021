...
{viewerjumpto "Saved results" "tabulate_oneway##saved_results"}{...}
{title:Title}

{p2colset 5 28 30 2}{...}
{p2col:{manlink R tabulate oneway} {hline 2}}One-way tables of frequencies{p_end}
{p2colreset}{...}
...
{phang2}
{bf:Statistics > Summaries, tables, and tests > Tables > One-way tables}
...
{phang2}
{bf:Statistics > Summaries, tables, and tests > Tables > Multiple one-way tables}
...
n-way tables of frequencies and a wide variety of statistics.  See
...
{pstd}
{cmd:tabulate} and {cmd:tab1} save the following in {cmd:r()}:

...
{viewerjumpto "Saved results" "tsappend##saved_results"}{...}
{title:Title}

{p2colset 5 22 24 2}{...}
{p2col :{manlink TS tsappend} {hline 2}}Add observations to a time-series dataset{p_end}
{p2colreset}{...}
...
{cmd:th} (half-yearly), and {cmd:ty} (yearly).
...
{pstd}
{cmd:tsappend} saves the following in {cmd:r()}:

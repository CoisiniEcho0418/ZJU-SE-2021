...
{viewerjumpto "Saved results" "tsfilter bk##saved_results"}{...}
{viewerjumpto "Reference" "tsfilter bk##reference"}{...}
{title:Title}

{p2colset 5 25 27 2}{...}
{p2col :{manlink TS tsfilter bk} {hline 2}}Baxter-King time-series filter{p_end}
{p2colreset}{...}
...
{pstd}
{cmd:tsfilter bk} saves the following in {cmd:r()}:

...
{viewerjumpto "Saved results" "tssmooth_exponential##saved_results"}{...}
{title:Title}

{p2colset 5 34 36 2}{...}
{p2col :{manlink TS tssmooth exponential} {hline 2}}Single-exponential smoothing{p_end}
{p2colreset}{...}
...
prediction, where {bind:{cmd:0} {ul:<} {it:#} {ul:<} {cmd:500}}.  The default
...
{pstd}
{cmd:tssmooth exponential} saves the following in {cmd:r()}:

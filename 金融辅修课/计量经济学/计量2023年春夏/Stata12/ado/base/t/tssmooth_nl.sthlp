...
{viewerjumpto "Saved results" "tssmooth nl##saved_results"}{...}
{title:Title}

{p2colset 5 25 27 2}{...}
{p2col :{manlink TS tssmooth nl} {hline 2}}Nonlinear filter{p_end}
{p2colreset}{...}
...
{phang}
{cmd:smooth(}{it:smoother}[{cmd:, twice}]{cmd:)} specifies the nonlinear
smoother to be used.
...
{pstd}
{cmd:tssmooth nl} saves the following in {cmd:r()}:

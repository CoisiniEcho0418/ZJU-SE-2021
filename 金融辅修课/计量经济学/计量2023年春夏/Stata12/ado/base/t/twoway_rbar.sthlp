...
{p2colset 5 32 34 2}{...}
{p2col :{manlink G-2 graph twoway rbar} {hline 2}}Range plot with bars{p_end}
{p2colreset}{...}
...
{p2col:{cmdab:msiz:e:(}{it:{help markersizestyle}}{cmd:)}}width of bar in
       {help relativesize:relative size} units{p_end}
...
{pmore}
    ...
    relative size units; see {manhelpi relativesize G-4}.

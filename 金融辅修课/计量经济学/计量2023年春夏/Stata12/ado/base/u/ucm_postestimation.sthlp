...
{viewerjumpto "Description" "ucm postestimation##description"}{...}
{viewerjumpto "Special-interest postestimation commands" "ucm postestimation##special"}{...}
{viewerjumpto "Syntax for predict" "ucm postestimation##syntax_predict"}{...}
{viewerjumpto "Options for predict" "ucm postestimation##options_predict"}{...}
{viewerjumpto "Syntax for estat period" "ucm postestimation##syntax_estat_period"}{...}
{viewerjumpto "Options for estat period" "ucm postestimation##options_estat_period"}{...}
{viewerjumpto "Examples" "ucm postestimation##examples"}{...}
{title:Title}

{p2colset 5 32 34 2}{...}
{p2col :{manlink TS ucm postestimation} {hline 2}}Postestimation tools for
ucm{p_end}
...
{p 8 16 2}
{cmd:predict} {dtype}
{{it:stub}{cmd:*} | {it:{help newvarlist}}} 
{ifin}
...
{synoptline}
{syntab :Options}
{synopt :{cmd:rmse(}{it:stub*} | {it:{help newvarlist}}{cmd:)}}put estimated
          root mean squared errors of predicted statistics in new variables
{p_end}
...
{phang}
{cmd:rmse(}{it:stub}{cmd:*} | {it:{help newvarlist}}{cmd:)} puts the root mean
...
{title:Options for estat period}

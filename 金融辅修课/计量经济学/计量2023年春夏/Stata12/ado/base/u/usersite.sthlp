...
{cmd:WIN} (32-bit x86) and
{cmd:WIN64A} (64-bit x86-64)
for Windows;
{cmd:MACINTEL} (32-bit Intel, GUI),
{cmd:OSX.X86} (32-bit Intel, console),
{cmd:MACINTEL64} (64-bit Intel, GUI),
{cmd:OSX.X8664} (64-bit Intel, console),
{cmd:MAC} (32-bit PowerPC), and
{cmd:OSX.PPC} (32-bit PowerPC),
for Mac; and
{cmd:LINUX} (32-bit x86),
{cmd:LINUX64} (64-bit x86-64),
{cmd:SOL64}, and
{cmd:SOLX8664} (64-bit x86-64)
for Unix.

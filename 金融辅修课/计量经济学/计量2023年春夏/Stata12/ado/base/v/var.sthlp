...
{p2colset 5 17 19 2}{...}
{p2col:{manlink TS var} {hline 2}}Vector autoregressive models{p_end}
{p2colreset}{...}
...
{synopt :{it:{help var##display_options:display_options}}}control column
...
{opt nolog} can be specified only when {opt constraints()} is specified.
...
{mansection TS varRemarksFittingmodelswithsomelagsexcluded:{it:Fitting models with some lags excluded}} in {hi:[TS] var}.
...
{pstd}
{cmd:var} saves the following in {cmd:e()}:
...
{synopt:{cmd:e(exogvars)}}names of exogenous, if specified{p_end}
...
{synopt:{cmd:e(constraints)}}{cmd:constraints}, if specified{p_end}

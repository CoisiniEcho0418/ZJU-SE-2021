...
{p 5 9 2}
{* fix}
6.  {helpb logistic_postestimation##estatgof:estat gof}, when used after a
...
{p 5 9 2}
{* fix}
3.  {helpb discrim lda postestimation##estatanova:estat anova} after
...
8.  The {cmd:beta()} option was mistakenly added to the documentation and
    dialog boxes for {helpb logistic_postestimation##estatgof:estat gof} and
    {helpb logistic_postestimation##estatclas:estat classification} after

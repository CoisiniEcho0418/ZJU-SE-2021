...
13.  {help graph_bar:graph bar}, {help graph_dot:graph dot},
     ...
     {cmd:over()} groups in all of the dataset, not just groups in the sample
...
14.  {help graph_bar:graph bar}, {help graph_dot:graph dot},
     ...
     could produce legends that were not correct for all of the by graphs.
     This has been fixed.

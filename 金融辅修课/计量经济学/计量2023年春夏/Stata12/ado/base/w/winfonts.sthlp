...
{viewerjumpto "Changing and saving fonts and positions of your windows" "winfonts##remarks1"}{...}
{viewerjumpto "Changing color schemes" "winfonts##remarks2"}{...}
{viewerjumpto "Managing your preferences" "winfonts##remarks3"}{...}
{viewerjumpto "Closing and opening windows" "winfonts##remarks4"}{...}
{title:Title}
...
{p 8 25 2}{hi:Graph}{space 12}(TrueType fonts only){p_end}
{p 8 25 2}{hi:Viewer}{space 11}(fixed-width fonts only){p_end}
{p 8 25 2}{hi:Command}{space 10}(any font){p_end}
{p 8 25 2}{hi:Review}{space 11}(any font){p_end}
{p 8 25 2}{hi:Variables}{space 8}(any font){p_end}
{p 8 25 2}{hi:Data Editor}{space 6}(fixed-width fonts only){p_end}
{p 8 25 2}{hi:Do-file Editor}{space 3}(fixed-width TrueType fonts only)

{p 8 8 2}(Fixed-width fonts are "typewriter" fonts like Courier.)


{p 4 4 2}
To change the font for a window:

{p 8 12 2}1.  Right-click on a window and select {cmd:Font...}{p_end}
{p 8 12 2}2.  Select the font


{p 4 4 2}
To change the font for the Do-file Editor:

{p 8 12 2}1.  Right-click on the Do-file Editor  and select {cmd:Preferences...}{p_end}
{p 8 12 2}2.  Select the font
...
{p 8 12 2}1.  Select {cmd:Edit > Preferences > Manage Preferences > Save Preferences > New Preference Set}.{p_end}
...
{p 8 8 2}Select {cmd:Edit > Preferences > Manage Preferences > Load Preferences >} {it: preference_name}.


{p 4 4 2}
To restore the factory settings for the fonts, graph settings, and window arrangements:

{p 8 8 2}Select {cmd:Edit > Preferences > Manage Preferences > Load Preferences > Factory Settings}.

...
{p2colset 5 20 22 2}{...}
{p2col :{manlink XT xtdata} {hline 2}}Faster specification searches with xt data{p_end}
...
more quickly than {cmd:xtreg}; see {manhelp xtreg XT}.  Using {cmd:xtdata, re}
also creates a variable named {opt constant}.  When using {cmd:regress} after
...
This is the ratio in standard deviations, not the variances.

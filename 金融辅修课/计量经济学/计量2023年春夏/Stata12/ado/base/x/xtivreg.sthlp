...
{vieweralsosee "" "--"}{...}
{vieweralsosee "[XT] ivregress" "help ivregress"}{...}
...
{viewerjumpto "Saved results" "xtivreg##saved_results"}{...}
{viewerjumpto "References" "xtivreg##references"}{...}
{title:Title}

{p2colset 5 21 23 2}{...}
{p2col :{manlink XT xtivreg} {hline 2}}Instrumental variables and two-stage least squares for panel-data models{p_end}
{p2colreset}{...}
...
{synopt :{opt first}}report first-stage estimates{p_end}
{synopt :{opt sm:all}}report {it:t} and {it:F} statistics instead of {it:Z} and chi-squared statistics{p_end}
{synopt :{it:{help xtivreg##fd_display_options:display_options}}}control column
formats, row spacing, line width, and display of omitted variables{p_end}
...
{pstd}
See {help xtivreg##B2008:Baltagi (2008)} for an introduction to panel-data
...
that the instrument list be ignored.  Specifying {opt regress}
...
{pstd}
{cmd:xtivreg, re} saves the following in {cmd:e()}:
...
{pstd}
{cmd:xtivreg, be} saves the following in {cmd:e()}:
...
{pstd}
{cmd:xtivreg, fe} saves the following in {cmd:e()}:
...
{synopt:{cmd:e(df_b)}}degrees of freedom for the chi-squared statistic{p_end}
{synopt:{cmd:e(chi2_p)}}p-value for model chi-squared test{p_end}
{synopt:{cmd:e(rho)}}rho{p_end}
{synopt:{cmd:e(F)}}F statistic ({cmd:small} only){p_end}
...
{pstd}
{cmd:xtivreg, fd} saves the following in {cmd:e()}:
...
{synopt:{cmd:e(N_g)}}number of groups{p_end}
{synopt:{cmd:e(rss)}}residual sum of squares{p_end}
{synopt:{cmd:e(df_r)}}residual d.o.f. ({cmd:small} only){p_end}

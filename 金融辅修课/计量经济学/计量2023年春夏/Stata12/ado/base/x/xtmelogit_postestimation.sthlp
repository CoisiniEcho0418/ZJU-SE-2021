{smcl}
{* *! version 1.4.4  11feb2011}{...}
{viewerdialog predict "dialog xtmelogit_p"}{...}
{viewerdialog estat "dialog xtmelogit_estat"}{...}
{vieweralsosee "[XT] xtmelogit postestimation" "mansection XT xtmelogitpostestimation"}{...}
{vieweralsosee "" "--"}{...}
...
{p2colset 5 38 40 2}{...}
{p2col :{manlink XT xtmelogit postestimation} {hline 2}}Postestimation tools for
xtmelogit{p_end}
{p2colreset}{...}

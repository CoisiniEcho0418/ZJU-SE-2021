...
{p2colset 5 25 27 2}{...}
{synopt :{manlink XT xtmepoisson} {hline 2}}Multilevel mixed-effects Poisson regression{p_end}
{p2colreset}{...}
...
{mansection XT xtmelogitRemarksex5_xtmelogit:example 5}
in {bf:[XT] xtmelogit} for more details.
...
{pstd}Four-level nested model, fit using {help xtmepoisson##laplace:laplace}{p_end}

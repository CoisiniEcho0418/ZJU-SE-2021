{smcl}
{* *! version 1.2.3  18jun2011}{...}
{viewerdialog predict "dialog xtmixed_p"}{...}
{viewerdialog estat "dialog xtmixed_estat"}{...}
{vieweralsosee "[XT] xtmixed postestimation" "mansection XT xtmixedpostestimation"}{...}
{vieweralsosee "" "--"}{...}
...
{p2colset 5 36 38 2}{...}
{p2col :{manlink XT xtmixed postestimation} {hline 2}}Postestimation tools for
xtmixed{p_end}
{p2colreset}{...}

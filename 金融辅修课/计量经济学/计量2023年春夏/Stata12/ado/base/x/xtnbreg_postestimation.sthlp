...
{viewerjumpto "Description" "xtnbreg postestimation##description"}{...}
{viewerjumpto "Syntax for predict" "xtnbreg postestimation##syntax_predict"}{...}
{viewerjumpto "Options for predict" "xtnbreg postestimation##options_predict"}{...}
{viewerjumpto "Examples" "xtnbreg postestimation##examples"}{...}
{title:Title}

{p2colset 5 36 38 2}{...}
{p2col :{manlink XT xtnbreg postestimation} {hline 2}}Postestimation tools
for xtnbreg{p_end}
{p2colreset}{...}
...
{p2coldent :(1) {helpb estat}}AIC, BIC, VCE, and estimation sample
summary{p_end}
...
{p2colreset}{...}
{p 4 6 2}
(1) {cmd:estat ic} is not appropriate after {cmd: xtnbreg, pa}.
{p_end}

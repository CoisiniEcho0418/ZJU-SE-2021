...
{p2colset 5 24 26 2}{...}
{p2col :{manlinki G-3 by_option} {hline 2}}Option for repeating graph command{p_end}
{p2colreset}{...}
...
{pstd}
Option {cmd:by()} draws separate plots within one graph.
{varlist} may be a numeric or a string variable.

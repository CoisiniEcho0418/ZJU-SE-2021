...
{p2colset 5 35 37 2}{...}
{p2col :{manlinki G-3 marker_label_options} {hline 2}}Options for specifying marker labels{p_end}
{p2colreset}{...}
...
{p2col:{cmdab:mlabv:position:(}{varname}{cmd:)}}where to locate the label
       2{p_end}
{p2col:{cmdab:mlabg:ap:(}{it:{help relativesize}}{cmd:)}}gap between marker
      and label{p_end}
...
{p2col:{cmdab:mlabc:olor:(}{it:{help colorstyle}}{cmd:)}}color of label{p_end}
{p2line}
{p2colreset}{...}
{p 4 6 2}
...
{cmd:mlabtextstyle(}{it:textstyle}{cmd:)}
    ...
    you will find that a {it:textstyle} defines much more, but all those other
    things are ignored for marker labels.  In any case,
